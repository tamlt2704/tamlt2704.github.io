...
export function Quiz({ question, options, answer, explanation }: QuizProps) {
  ...
  return (
    ...
    <div className="my-8 p-6 rounded-lg border border-gray-200 bg-gray-50">
      ...
      <div className="space-y-2">
        ...
        {options.map((option, i) => {
          ...
          if (revealed) {
            if (i === answer) style = "border-green-500 bg-green-50";       // correct answer: green
            else if (i === selected) style = "border-red-400 bg-red-50";    // wrong selection: red
          ...
          return (
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-md border text-sm transition ${style}`}
            >
